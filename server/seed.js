...
const createProducts = () => [
  {
    ...
    description: 'Trandafiri rosii cu eucalipt proaspat',
    price: 89.99,
    category: 'trandafiri',
  ...
  },
  {
    ...
    price: 96,
    category: 'mix',
    imageUrl: '/images/buchet-white-grace.jpg',
    stock: 8,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 129,
    category: 'bujori',
    imageUrl: '/images/bujori-deluxe.jpg',
    stock: 10,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 59.99,
    category: 'crizanteme',
    imageUrl: '/images/crizanteme-vesele.jpg',
    stock: 25,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 69,
    category: 'iris',
    imageUrl: '/images/iris-royal-blue.webp',
    stock: 18,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 54,
    category: 'verdeata',
    imageUrl: '/images/eucalipt-fresh-touch.jpg',
    stock: 30,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 99.5,
    category: 'mix',
    imageUrl: '/images/buchet-sunset.jpg',
    stock: 12,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 110,
    category: 'plante',
    imageUrl: '/images/planta-monstera.png',
    stock: 7,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 145,
    category: 'mix',
    imageUrl: '/images/buchet-festival.png',
    stock: 6,
    isAvailable: true,
    createdAt: new Date().toISOString()
  }
