...
const createProducts = () => [
  {
    ...
    price: 89.99,
    category: 'trandafiri',
    imageUrl: 'https://images.unsplash.com/photo-1520763185298-1b434c919102?w=400&q=80',
    stock: 15,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 74.5,
    category: 'lalele',
    imageUrl: 'https://images.unsplash.com/photo-1470509037663-253afd7f0f51?w=400&q=80',
    stock: 20,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    price: 59.99,
    category: 'crizanteme',
    imageUrl: 'https://images.unsplash.com/photo-1572451479139-6a308211d8be?w=400&q=80',
    stock: 25,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  ...
  },
  {
    ...
    price: 54,
    category: 'verdeata',
    imageUrl: 'https://images.unsplash.com/photo-1526045478516-99145907023c?w=400&q=80',
    stock: 30,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 99.5,
    category: 'mix',
    imageUrl: 'https://images.unsplash.com/photo-1525310072745-f49212b5ac6d?w=400&q=80',
    stock: 12,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 110,
    category: 'plante',
    imageUrl: 'https://images.unsplash.com/photo-1463320726281-696a485928c7?w=400&q=80',
    stock: 7,
    isAvailable: true,
    createdAt: new Date().toISOString()
  },
  {
    ...
    price: 145,
    category: 'mix',
    imageUrl: 'https://images.unsplash.com/photo-1487530811015-780780169a86?w=400&q=80',
    stock: 6,
    isAvailable: true,
    createdAt: new Date().toISOString()
  }
